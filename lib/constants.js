...
// 1. PRECIOS UNITARIOS AL POR MAYOR (BOM)
...
// 2. FACTORES DE DESCUENTO COMERCIAL / REFERIDO
...
// 3. OPCIONES DE MOTORES (HP A WATTS)
...
// 4. CATÁLOGOS AUXILIARES PARA EL PERSONALIZADOR MANUAL
...
// 5. LAS 10 ECUACIONES CALIBRADAS DE EXCEL
...
// 6. CATÁLOGO COMERCIAL OFICIAL DE KITS (K1 a K10)
export const KITS = [
  {
    id: 'K1',
  ...
  },
  {
    ...
    soporte: 4,
    cable: 100,
    precioFinal: 25620000,
    precioConDescuento: 23570400
  },
  {
    id: 'K5',
    nombre: 'KIT Hogar Básico 2',
    paneles: 9,
    panelW: 625,
    panelModelo: 'Luxen, Monofacial 625W',
    totalWp: 5625,
    ...
    bateriaModelo: 'Batería LFP FOC Energy, 48V, 11 KWh',
    totalBateriaKwh: 11.0,
    proteccionDC: 'Combiner Box DC Suntree 5 in 1 out',
    soporte: 5,
    cable: 74,
    precioFinal: 26390000,
    precioConDescuento: 24410750
  },
  {
    id: 'K6',
    ...
    totalBateriaKwh: 16.0,
    proteccionDC: 'Combiner Box DC Suntree 4 in 1 out',
    soporte: 6,
    cable: 110,
    precioFinal: 29020000,
    precioConDescuento: 26988600
  },
  {
    id: 'K7',
    ...
    bateriaCant: 2,
    bateriaModelo: 'Batería LFP FOC Energy, 48V, 11 KWh',
    totalBateriaKwh: 22.0,
    proteccionDC: 'Combiner Box DC Suntree 2 in 2 out',
    soporte: 7,
    cable: 70,
    precioFinal: 48850000,
    precioConDescuento: 45919000
  },
  {
    id: 'K8',
    ...
    soporte: 9,
    cable: 74,
    precioFinal: 49900000,
    precioConDescuento: 47155500
  },
  {
    id: 'K9',
    nombre: 'KIT Hogar Full +',
    ...
    bateriaCant: 2,
    bateriaModelo: 'Batería LFP FOC Energy, 48V, 16 KWh',
    totalBateriaKwh: 32.0,
    proteccionDC: 'Combiner Box DC Suntree 3 in 3 out',
    soporte: 11,
    cable: 98,
    precioFinal: 57090000,
    precioConDescuento: 54235500
  },
  {
    id: 'K10',
    ...
    bateriaCant: 3,
    bateriaModelo: 'Batería LFP FOC Energy, 48V, 16 KWh',
    totalBateriaKwh: 48.0,
    proteccionDC: 'Combiner Box DC Suntree 3 in 3 out',
    soporte: 14,
    cable: 98,
    precioFinal: 73260000,
    precioConDescuento: 69890040
  }
];
