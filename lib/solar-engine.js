...
// TABLA OFICIAL DE PRECIOS Y DESCUENTOS SIN REDONDEAR
export const OFFICIAL_KIT_PRICES = {
  K1:  { lista: 14510000, desc: 13059000 },
  K2:  { lista: 17170000, desc: 15624700 },
  K3:  { lista: 21840000, desc: 20092800 },
  K4:  { lista: 24520000, desc: 22558400 },
  K5:  { lista: 25150000, desc: 23263750 },
  K6:  { lista: 28750000, desc: 26737500 },
  K7:  { lista: 47760000, desc: 44894400 },
  K8:  { lista: 49900000, desc: 47155500 },
  K9:  { lista: 57090000, desc: 54235500 },
  K10: { lista: 70990000, desc: 67724460 }
};
...
export function calcManualBattery(bankKwh, voltage, battKwh, requiredInverterW = 0) {
  ...
  if (voltage === 24) {
    ...
    // En 24V limitamos a máx 1 pareja (2 baterías) en cálculo automático para evitar desbalance
